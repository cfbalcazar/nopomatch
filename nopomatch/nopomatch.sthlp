{smcl}
{* *! version 1.1.0 09Spe2013}
{* *! version 1.2.0 18Apr2013}
{* *! version 1.3.0 24may2010}
{cmd:help nopomatch}
{hline}
...
{synopt:{it: by:}} dummy (0/1) that discriminates the sample to perform the computation of the gap. (e.g.: gender.) Think of 1 as being in the treated group, 0 otherwise.{p_end}
{p2colreset}{...}
...
{synoptline}
{syntab:Main}
{synopt:{opt binary}} decomposition for a binary outcome (a continuous outcome is the program's default). {p_end}
